...
tests/fm-spawn-lease.test.sh              # leased crew/scout worktree acquisition: treehouse get --lease --lease-holder token, worktree path captured from stdout not the pane cwd, and lease_holder= recorded in meta
